...
define("REMOTE_REPOSITORY", "git@github.com:ling1729/CardinalHoursWeb.git"); // The SSH URL to your repository
define("DIR", "/home/ling/CardinalHoursWeb");                          // The path to your repostiroy; this must begin with a forward slash (/)
